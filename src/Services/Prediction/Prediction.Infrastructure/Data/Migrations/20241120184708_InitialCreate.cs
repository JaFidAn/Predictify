...
namespace Prediction.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ForecastEvaluations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ForecastId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActualOutcomeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForecastEvaluations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutcomeTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamLeagueSeasons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamLeagueSeasons_Leagues_LeagueId",
                        column: x => x.LeagueId,
                        principalTable: "Leagues",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamLeagueSeasons_Seasons_SeasonId",
                        column: x => x.SeasonId,
                        principalTable: "Seasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamLeagueSeasons_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchOutcomeTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchOutcomeTypes_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchOutcomeTypes_OutcomeTypes_OutcomeTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_Team1Id_Team2Id_Date",
                table: "Matches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchOutcomeTypes_MatchId",
                table: "MatchOutcomeTypes",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchOutcomeTypes_OutcomeTypeId",
                table: "MatchOutcomeTypes",
                column: "OutcomeTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_OutcomeTypes_Name",
                table: "OutcomeTypes",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamLeagueSeasons_LeagueId",
                table: "TeamLeagueSeasons",
                column: "LeagueId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamLeagueSeasons_SeasonId",
                table: "TeamLeagueSeasons",
                column: "SeasonId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamLeagueSeasons_TeamId_LeagueId_SeasonId",
                table: "TeamLeagueSeasons",
                columns: new[] { "TeamId", "LeagueId", "SeasonId" },
                unique: true);
